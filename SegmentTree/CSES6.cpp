...
// build me 0 to n-1 sare ko leaf node tak jate hai or uplift hote hue merge krte hai;
// update me specific node tk pahucte hai aur uplift(post order) hote hue relevant node change krte hai
// query me agr given responsibity range of ind query range ke andr aata hai to pura seg[ind] return krte hai
